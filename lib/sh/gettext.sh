...
# 0) CHECK FOR SED (OS DEPENDENT)
# the OS X sed is very limited, many devs have
# installed gnu gettext but we should handle both
# UPDATE: http://stackoverflow.com/questions/5694228/#22084103
#set +e
