...
export default Service.extend({
   ...
   *
   * By default, this is true if ifa.enabled = true in your config/environment.js.
   *
   ...
   * @protected
   */
  useAssetMap: computed(function() {
    return get(config, 'ifa.enabled');
  }),
